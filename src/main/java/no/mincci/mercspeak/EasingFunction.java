...
public enum EasingFunction {
    ...
    EASE_IN_QUADRATIC((t) -> t * t),
    EASE_IN_CUBIC((t) -> t * t * t),
    EASE_IN_QUARTIC((t) -> t * t * t * t),
    EASE_IN_QUINTIC((t) -> t * t * t * t * t),
    ...
    SMOOTHERSTEP ((t) -> { // Adapted from Perlin's improvement on smoothstep, based on  C++ implementation from https://en.wikipedia.org/wiki/Smoothstep
